...
export default function RightScroll() {
  ...
  return (
    <div className="absolute right-0 px-3 md:px-10 bottom-0 h-full z-20 flex items-center justify-center cursor-pointer"
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: show ? 1 : 0 }} transition={{ duration: 0.7 }}>
        <FaArrowRight className="md:w-[30px] md:h-[30px]" />
      </motion.div>
    </div >
  )
}
